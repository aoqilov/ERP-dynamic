...
} from "@/store/slices/settingsApi/SttExperienceApi";
import ModalExp from "@/components/settings/modal/experience/ModalExp";
import ModalExpEdit from "@/components/settings/modal/experience/ModalExpEdit";
...
const ExperiencePage = () => {
  ...
  const { data: jobData, isLoading } = useGetAllExperienceQuery();
  ...
  return (
    <div>
      ...
      <div className="table">
        ...
        <ModalExp open={isOpen} cancel={() => setIsOpen(false)} />
        <ModalExpEdit
          open={isOpenEdit}
