...
} from "@/store/slices/settingsApi/SttRegionApi";
import ModalRegion from "@/components/settings/modal/region/ModalRegion";
import ModalRegionEdit from "@/components/settings/modal/region/ModalRegionEdit";
...
const CountryPage = () => {
  ...
  const { data: jobData, isLoading } = useGetAllRegionTitlesQuery();
  ...
  return (
    <div>
      ...
      <div className="table">
        ...
        <ModalRegion open={isOpen} cancel={() => setIsOpen(false)} />
        <ModalRegionEdit
          open={isOpenEdit}
