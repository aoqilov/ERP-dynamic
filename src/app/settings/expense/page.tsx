...
} from "@/store/slices/settingsApi/SttExpenceApi";
import ModalExpence from "@/components/settings/modal/expence/ModalExpence";
import ModalExpenceEdit from "@/components/settings/modal/expence/ModalExpenceEdit";
...
const ExpencePage = () => {
  ...
  const { data: jobData, isLoading } = useGetAllExpenceQuery();
  ...
  return (
    <div>
      ...
      <div className="table">
        ...
        <ModalExpence open={isOpen} cancel={() => setIsOpen(false)} />
        <ModalExpenceEdit
          open={isOpenEdit}
