import { usePatchExpenceDataMutation } from "@/store/slices/settingsApi/SttExpenceApi";
...
const ModalExpenceEdit: React.FC<Props> = ({ cancel, open, oneData }) => {
  const [updataEditData, { isLoading }] = usePatchExpenceDataMutation();
...
export default ModalExpenceEdit;
