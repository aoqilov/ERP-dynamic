import { usePatchExperienceDataMutation } from "@/store/slices/settingsApi/SttExperienceApi";
...
const ModalExpEdit: React.FC<Props> = ({ cancel, open, oneData }) => {
  const [updataEditData, { isLoading }] = usePatchExperienceDataMutation();
