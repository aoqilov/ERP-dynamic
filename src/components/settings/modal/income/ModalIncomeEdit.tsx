import { usePatchIncomeDataMutation } from "@/store/slices/settingsApi/SttIncome";
...
const ModalIncomeEdit: React.FC<Props> = ({ cancel, open, oneData }) => {
  const [updataEditData, { isLoading }] = usePatchIncomeDataMutation();
