...
export const SettingsApi = createApi({
  ...
  baseQuery: fetchBaseQuery({
    ...
    prepareHeaders: (headers) => {
      const token =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwicm9sZSI6ImNlbyIsImlhdCI6MTc0NTgzMjc1NSwiZXhwIjoxNzQ2MDkxOTU1fQ.0g_FjylT5TsjqbEier3M2AFqfGGrO9ttxInxDo14b5E"; // or your own token
      if (token) {
  ...
  tagTypes: ["JobTitle"], // Define tag types
  endpoints: (builder) => ({
